...
export default function WindowProject() {
    ...
    const filteredProjects = categorySelect === "all"
        ? projects
    ...
    return (
        <section className={`scroll-css relative h-full w-full rounded-md bg-window p-6 text-text-main 
            ${projectSelected ? "overflow-hidden" : "overflow-y-auto"}`}>
            ...
            <AnimatePresence>
                {projectSelected && (
                    <motion.div
                        ...
                        className="absolute inset-0 z-50 grid place-items-center bg-black/45 px-3 p backdrop-blur-sm">
                        <motion.article
                            role="dialog"
                            aria-modal="true"
                            ...
                            className="relative grid min-h-140 gap-7 pt-14 overflow-y-auto rounded-md border border-border-muted bg-window p-4 text-text-main shadow-window md:grid-cols-[1.25fr_0.9fr]"
                        >
                            <CloseButton
                                type="button"
                                onClick={() => {
                            ...
                            <div className="flex min-w-0 flex-col justify-between gap-6">
                                <div>
                                    <div className="mb-4 flex flex-wrap items-center gap-3">
                                        ...
                                        <span className="ml-auto rounded-sm border border-border-muted bg-window-panel px-4 py-2 text-sm font-bold text-highlight">
